  ...
  return regeneratorRuntime.async(function fetchRepoList$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          return _context.abrupt("return", axios.get('https://api.github.com/orgs/zhu-cli/repos'));
  ...
  return regeneratorRuntime.async(function fetchTagList$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          return _context2.abrupt("return", axios.get("https://api.github.com/repos/zhu-cli/".concat(repo, "/tags")));
